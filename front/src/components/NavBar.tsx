  ...
  return (
    <nav className="max-w-none bg-gray-800 p-5 flex flex-row justify-between text-white px-10 items-center">
      ...
      <ol className="md:flex hidden flex-row gap-2 flex-wrap">
        <li key="xlsx"
            className={`transition-all duration-200 rounded-full px-5 py-1 navbar-item bg-cyan-700`}
            >
            <a href="/conxls">xlsx</a>
        </li>        
        <li key="xlsxagg"
            className={`transition-all duration-200 rounded-full px-5 py-1 navbar-item bg-cyan-700`}
            >
            <a href="/conaggxls">xlsx agg</a>
        </li>        
      </ol>      
      <h1 className="font-bold text-lg">NETRACER</h1>
    </nav>
  );
};
